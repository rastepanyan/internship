                ...
                if (!empty($_SESSION['cart'])) {
                    ...
                    foreach ($_SESSION['cart'] as $keys => $values) {
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <form class="form-group" action="/shop_V1/resources/delete_add_remove.php" method="post"
                                      enctype="multipart/form-data">
                                    <input type="hidden" name="product_id"
                                           value="<?php echo $values['product_id']; ?>"/>
                                    <button type="submit" name="remove_from_cart_btn" class="btn btn-danger btn-sm">
                                        Remove
                                    </button>
                                </form>
                            </td>
            ...
            <div class="row w-100 d-block">
                <div class="col">
                    <div class="float-left">
                        ...
                        <a class="btn btn-secondary btn-block" href="product_list.php">Back</a>
                    </div>
