<form class="form-group text-center" action="/shop_V1/resources/registration_complete.php" method="post"
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <div class="md-form">
                        ...
                        <input type="text" name="post_code" class="form-control" value="<?php echo $post_code; ?>"
                               required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <div class="md-form">
                        ...
                        <input type="text" name="country_code" class="form-control" value="<?php echo $country_code; ?>"
                               required>
                    </div>
                </div>
            </div>
